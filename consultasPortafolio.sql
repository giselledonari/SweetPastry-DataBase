...
insert into detalle_pago values (default,'finalizado','debito');
insert into compra values (default,'14-4','14-12-2022',11);
insert into detalle_compra values (default,1,2,11);
insert into detalle_compra values (default,5,3,11);
insert into detalle_compra values (default,8,1,11);
